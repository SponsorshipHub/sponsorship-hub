...
//         let query = `INSERT INTO junction_event_gender 
//     (event_id, gender_id, percentage) 
//     VALUES ($1, 1, $2), ($1, 2, $3), ($1, 3, $4);`;
//         const values = [req.body.id, req.body.gender1, req.body.gender2, req.body.gender3];
// //sending gender Demographics
// await sendDemo.query(query, values)
