...
CREATE TABLE "junction_event_type" (
	...
	FOREIGN KEY ("events_id") REFERENCES events ("id"));
		...
		('Art Festival'), ('Auto Show'), ('Beer Festival'), ('City Festival'),
		('Cultural Festival'), ('Film 	Festival'), ('Food & Wine Festival'),
		('Motorcycle Rally'), ('Music Festival'), ('Street Market Fest');
...
CREATE TABLE "junction_event_income" (
	...
	FOREIGN KEY ("income_range_id") REFERENCES income_range ("id"));
		...
		INSERT INTO income_range (income_range) VALUES
		('25000-'), ('25001-49999'), ('50000-75999'), ('76000-99999'), 
		('100000-149999'), ('150000-200000'), ('200001+');
...
CREATE TABLE "junction_event_residency" (
	...
	FOREIGN KEY ("residency_id") REFERENCES residency ("id"));
		...
		INSERT INTO residency (residency) VALUES
		('in_state'), ('out_of_state');
...
-- USERS --
INSERT INTO users (name, title, password, email, phone, access_level) VALUES
...
-- EVENTS --
INSERT INTO events (event_name, year_established, start_date, end_date, event_image_url, event_website, event_status, estimated_attendance, event_notes, contact_name, contact_title, contact_email, contact_phone, event_facebook, event_twitter, event_instagram, event_description) VALUES
...
INSERT INTO events (event_name, start_date, end_date, estimated_attendance) VALUES
('Spring Jam 2021', '2021-02-25 17:00:00.250411+00', '2021-03-01 23:00:00.250411+00', '13000');

-- VENUES --
INSERT INTO venues (name, address, city, state, zipcode, venue_notes, venue_capacity) VALUES
...
INSERT INTO junction_event_venue (venues_id, events_id) VALUES
(1, 1), (2, 2), (3, 3);

-- EVENT TYPE JUNCTION --
INSERT INTO junction_event_type (type_id, events_id) VALUES
(9, 1), (10, 2), (9, 3);